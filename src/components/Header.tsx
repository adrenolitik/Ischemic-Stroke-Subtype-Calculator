            ...
            <div>
              <div className="flex items-center space-x-2">
                <h1 className="text-lg font-bold text-slate-900 dark:text-white leading-tight">
                  Клинический калькулятор ишемического инсульта
                </h1>
                <span className="px-2 py-0.5 text-xs font-semibold bg-blue-100 text-blue-800 dark:bg-blue-950 dark:text-blue-300 rounded-full border border-blue-200 dark:border-blue-800">
                  TOAST 2.0 + OCSP
                </span>
              </div>
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Автоматизированный расчет этиологического подтипа и топографической классификации
              </p>
            </div>
          </div>
